...
00000000004019a0 <addval_273>:
  4019a0:	8d 87 48 89 c7 c3    	lea    -0x3c3876b8(%rdi),%eax  # movel %rax %rdi
  4019a6:	c3                   	ret
...
00000000004019c3 <setval_426>:
  4019c3:	c7 07 48 89 c7 90    	movl   $0x90c78948,(%rdi)       #89 c7 90 c3
  4019c9:	c3                   	ret
...
00000000004019db <getval_481>:
  4019db:	b8 5c 89 c2 90       	mov    $0x90c2895c,%eax   # movel %rax %rdx
  4019e0:	c3                   	ret
...
0000000000401a03 <addval_190>:
  401a03:	8d 87 41 48 89 e0    	lea    -0x1f76b7bf(%rdi),%eax  # movel %rsp %rax
  401a09:	c3                   	ret
...
0000000000401a11 <addval_436>:
  401a11:	8d 87 89 ce 90 90    	lea    -0x6f6f3177(%rdi),%eax  # movel %rcx %rsi
  401a17:	c3                   	ret
...
0000000000401a33 <getval_159>:
  401a33:	b8 89 d1 38 c9       	mov    $0xc938d189,%eax  # movel %rdx %rcx
  401a38:	c3                   	ret

0000000000401a39 <addval_110>:
  401a39:	8d 87 c8 89 e0 c3    	lea    -0x3c1f7638(%rdi),%eax   # movel %rsp %rax
  401a3f:	c3                   	ret
...
0000000000401a83 <addval_358>:
  401a83:	8d 87 08 89 e0 90    	lea    -0x6f1f76f8(%rdi),%eax  # movel %rsp %rax
  401a89:	c3                   	ret
